...
var _bookslist = __webpack_require__(/*! ./components/pages/bookslist */ "./src/components/pages/bookslist.js");
...
/***/ "./src/components/pages/bookslist.js":
/*!*******************************************!*\
  !*** ./src/components/pages/bookslist.js ***!
  \*******************************************/
/*! no static exports found */
  ...
  _createClass(BooksList, [{
    ...
    value: function render() {
      var booksList = this.props.books.map(function (item) {
        return _react2.default.createElement('div', { key: item.id }, _react2.default.createElement('h2', null, item.title), _react2.default.createElement('h2', null, item.description), _react2.default.createElement('h2', null, item.price));
      });

      return _react2.default.createElement('div', null, _react2.default.createElement('h1', null, 'Hello React'), booksList);
    }
  }]);
...
function booksReducers() {
  ...
  switch (action.type) {
    ...
    case 'DELETE_BOOK':
      var copyOfBooksToDelete = [].concat(_toConsumableArray(state.books));
      var indexOfBookToDelete = copyOfBooksToDelete.findIndex(function (book) {
        return book.id === action.payload.id;
      }); //improve for deep clone
      return { books: [].concat(_toConsumableArray(copyOfBooksToDelete.slice(0, indexOfBookToDelete)), _toConsumableArray(copyOfBooksToDelete.slice(indexOfBookToDelete + 1))) };
    case 'UPDATE_BOOK':
      var copyOfBooksToUpdate = [].concat(_toConsumableArray(state.books));
      var indexOfBookToUpdate = copyOfBooksToUpdate.findIndex(function (book) {
        return book.id === action.payload.id;
      }); //improve for deep clone
      var bookToUpdate = _extends({}, copyOfBooksToUpdate[indexOfBookToUpdate], {
        title: action.payload.title
      });
      return { books: [].concat(_toConsumableArray(copyOfBooksToUpdate.slice(0, indexOfBookToUpdate)), [bookToUpdate], _toConsumableArray(copyOfBooksToUpdate.slice(indexOfBookToUpdate + 1))) };
    default:
      return state;
  }
};
